...
const sendEmail = (to, url, name, txt) => {
  ...
  const mailOptions = {
    ...
    html: `
            ...
            <img src="../assets/PP.png" alt style="display: block; margin:auto;" width="205"; >
            <h2 style="text-align: center; text-transform: uppercase;color: rgb(37, 132, 214);">Welcome to TechAxis.</h2>
            Hey <strong> ${name},</strong>
            Thanks for signing up at TechAxis.   
